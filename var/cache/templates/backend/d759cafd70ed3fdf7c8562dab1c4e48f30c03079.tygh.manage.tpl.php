<?php /* Smarty version Smarty-3.1.21, created on 2021-01-20 11:31:09
         compiled from "/var/www/html/cscart/design/backend/templates/views/products/manage.tpl" */ ?>
<?php /*%%SmartyHeaderCode:4722747156007ea4d40b9f9-50778996%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd759cafd70ed3fdf7c8562dab1c4e48f30c03079' => 
    array (
      0 => '/var/www/html/cscart/design/backend/templates/views/products/manage.tpl',
      1 => 1606799788,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '4722747156007ea4d40b9f9-50778996',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_6007ea4d5f4490_11551530',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_6007ea4d5f4490_11551530')) {function content_6007ea4d5f4490_11551530($_smarty_tpl) {?><?php if (!is_callable('smarty_function_script')) include '/var/www/html/cscart/app/functions/smarty_plugins/function.script.php';
if (!is_callable('smarty_block_hook')) include '/var/www/html/cscart/app/functions/smarty_plugins/block.hook.php';
if (!is_callable('smarty_modifier_to_json')) include '/var/www/html/cscart/app/functions/smarty_plugins/modifier.to_json.php';
if (!is_callable('smarty_modifier_truncate')) include '/var/www/html/cscart/app/functions/smarty_plugins/modifier.truncate.php';
?><?php
\Tygh\Languages\Helper::preloadLangVars(array('position_short','name','sku','price','list_price','purchased_qty','subtotal_sum','quantity','status','name','price','list_price','purchased_qty','subtotal_sum','quantity','edit','delete','status','no_data','text_select_fields2edit_note','modify_selected','global_update','bulk_product_addition','product_subscriptions','export_found_products','add_product','select_fields_to_edit','products'));
?>
...
">
                <?php $_smarty_tpl->smarty->_tag_stack[] = array('hook', array('name'=>"products:list_price")); $_block_repeat=true; echo smarty_block_hook(array('name'=>"products:list_price"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
                    ...
                    <?php echo $_smarty_tpl->getSubTemplate ("buttons/update_for_all.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('absolute_position'=>false,'display'=>$_smarty_tpl->tpl_vars['show_update_for_all']->value,'object_id'=>"price_".((string)$_smarty_tpl->tpl_vars['product']->value['product_id']),'name'=>"update_all_vendors[price][".((string)$_smarty_tpl->tpl_vars['product']->value['product_id'])."]"), 0);?>
                    <input type="text" name="products_data[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value['product_id'], ENT_QUOTES, 'UTF-8');?>
...
$_tmp1=ob_get_clean();?><?php smarty_template_function_btn($_smarty_tpl,array('type'=>"list",'text'=>$_smarty_tpl->__("delete"),'class'=>"cm-confirm",'href'=>"products.delete?product_id=".((string)$_smarty_tpl->tpl_vars['product']->value['product_id']).$_tmp1,'method'=>"POST"));?>
