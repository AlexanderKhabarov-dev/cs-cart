<?php /* Smarty version Smarty-3.1.21, created on 2021-01-19 22:05:19
         compiled from "/var/www/html/cscart/design/backend/templates/components/bottom_panel/bottom_panel.tpl" */ ?>
<?php /*%%SmartyHeaderCode:42301011660072d6fa6af75-04504346%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '99894923802be46df39cdafa8c7e0120f6271710' => 
    array (
      0 => '/var/www/html/cscart/design/backend/templates/components/bottom_panel/bottom_panel.tpl',
      1 => 1606799788,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '42301011660072d6fa6af75-04504346',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_60072d6fbb7ad8_60075400',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_60072d6fbb7ad8_60075400')) {function content_60072d6fbb7ad8_60075400($_smarty_tpl) {?><?php if (!is_callable('smarty_block_styles')) include '/var/www/html/cscart/app/functions/smarty_plugins/block.styles.php';
...
if (!is_callable('smarty_modifier_enum')) include '/var/www/html/cscart/app/functions/smarty_plugins/modifier.enum.php';
if (!is_callable('smarty_modifier_replace')) include '/var/www/html/cscart/app/lib/vendor/smarty/smarty/libs/plugins/modifier.replace.php';
...
<?php $_smarty_tpl->_capture_stack[0][] = array("settings_menu_main_links", null, null); ob_start(); ?>
    <?php if (fn_check_permissions("themes","manage","admin",'',array(),@constant('AREA'),$_smarty_tpl->tpl_vars['auth']->value['user_id'])&&($_smarty_tpl->tpl_vars['auth']->value['user_type']!==smarty_modifier_enum("UserTypes::VENDOR")||$_smarty_tpl->tpl_vars['settings']->value['Vendors']['can_edit_styles']===smarty_modifier_enum("YesNo::YES"))) {?>
...
"><?php echo $_smarty_tpl->__("bottom_panel.change_theme");?>
    ...
    <?php }?>
    <?php if (fn_check_permissions("block_manager","manage","admin",'',array(),@constant('AREA'),$_smarty_tpl->tpl_vars['auth']->value['user_id'])&&($_smarty_tpl->tpl_vars['auth']->value['user_type']!==smarty_modifier_enum("UserTypes::VENDOR")||$_smarty_tpl->tpl_vars['settings']->value['Vendors']['can_edit_blocks']===smarty_modifier_enum("YesNo::YES"))) {?>
...
"><?php echo $_smarty_tpl->__("bottom_panel.edit_layout");?>
    ...
    <?php }?>
    <?php if (fn_check_permissions("templates","manage","admin",'',array(),@constant('AREA'),$_smarty_tpl->tpl_vars['auth']->value['user_id'])&&(empty($_smarty_tpl->tpl_vars['auth']->value['company_id'])||fn_check_company_permissions("templates","manage",'',array()))) {?>
...
"><?php echo $_smarty_tpl->__("bottom_panel.edit_template");?>
    ...
    <?php }?>
    <?php if (fn_check_permissions("languages","translations","admin",'',array(),@constant('AREA'),$_smarty_tpl->tpl_vars['auth']->value['user_id'])&&(empty($_smarty_tpl->tpl_vars['auth']->value['company_id'])||fn_check_company_permissions("languages","translations",'',array()))) {?>
...
"><?php echo $_smarty_tpl->__("bottom_panel.edit_menus");?>
    ...
    <?php }?>
    <?php if ($_smarty_tpl->tpl_vars['page']->value==="products"&&fn_check_permissions("tabs","manage","admin",'',array(),@constant('AREA'),$_smarty_tpl->tpl_vars['auth']->value['user_id'])&&(empty($_smarty_tpl->tpl_vars['auth']->value['company_id'])||fn_check_company_permissions("tabs","manage",'',array()))) {?>
...
echo htmlspecialchars(fn_url('',"A"), ENT_QUOTES, 'UTF-8');
        ...
        <div class="bp-nav
            ...
            <a href="<?php echo htmlspecialchars(fn_url("bottom_panel.redirect?url=".((string)urlencode($_smarty_tpl->tpl_vars['config']->value['current_url']))."&area=".((string)@constant('AREA'))."&to_area=C",$_smarty_tpl->tpl_vars['redirect_area']->value), ENT_QUOTES, 'UTF-8');?>
"
...
" class="bp-nav__item cm-no-ajax
            ...
            <?php if (fn_allowed_for("MULTIVENDOR")) {?>
                <?php if (defined("THEMES_PANEL")||$_smarty_tpl->tpl_vars['auth']->value['user_type']===smarty_modifier_enum("UserTypes::VENDOR")) {?>
                    <a href="<?php echo htmlspecialchars(fn_url("bottom_panel.login_as_vendor?url=".((string)urlencode($_smarty_tpl->tpl_vars['config']->value['current_url']))."&area=".((string)@constant('AREA'))."&user_id=".((string)$_smarty_tpl->tpl_vars['auth']->value['user_id']),"C"), ENT_QUOTES, 'UTF-8');?>
...
$_tmp9=ob_get_clean();?><?php echo htmlspecialchars(fn_url("customization.update_mode?type=theme_editor&status=enable&return_url=".$_tmp9), ENT_QUOTES, 'UTF-8');
                ...
                <?php }?>
                <?php if (fn_check_permissions("customization","update_mode","admin",'',array("type"=>"block_manager"),@constant('AREA'),$_smarty_tpl->tpl_vars['auth']->value['user_id'])&&(empty($_smarty_tpl->tpl_vars['auth']->value['company_id'])||fn_check_company_permissions("customization","update_mode",'',array("type"=>"block_manager")))&&$_smarty_tpl->tpl_vars['auth']->value['user_type']!==smarty_modifier_enum("UserTypes::CUSTOMER")) {?>
