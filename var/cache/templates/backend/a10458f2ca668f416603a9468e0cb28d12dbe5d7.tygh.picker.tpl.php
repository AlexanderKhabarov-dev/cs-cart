<?php /* Smarty version Smarty-3.1.21, created on 2021-01-20 11:31:11
         compiled from "/var/www/html/cscart/design/backend/templates/pickers/orders/picker.tpl" */ ?>
<?php /*%%SmartyHeaderCode:16434240566007ea4f01d8b4-00687013%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a10458f2ca668f416603a9468e0cb28d12dbe5d7' => 
    array (
      0 => '/var/www/html/cscart/design/backend/templates/pickers/orders/picker.tpl',
      1 => 1606799788,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '16434240566007ea4f01d8b4-00687013',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_6007ea4f0ceba7_15510008',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_6007ea4f0ceba7_15510008')) {function content_6007ea4f0ceba7_15510008($_smarty_tpl) {?><?php if (!is_callable('smarty_function_math')) include '/var/www/html/cscart/app/lib/vendor/smarty/smarty/libs/plugins/function.math.php';
...
$_tmp7=ob_get_clean();?><?php echo $_smarty_tpl->getSubTemplate ("buttons/button.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('but_id'=>"opener_picker_".((string)$_smarty_tpl->tpl_vars['data_id']->value),'but_onclick'=>"Tygh."."$".".cePicker('delete_js_item', '".((string)$_smarty_tpl->tpl_vars['data_id']->value)."', 'delete_all', 'o'); Tygh."."$".".cePicker('check_items_qty', '".((string)$_smarty_tpl->tpl_vars['data_id']->value)."', '".$_tmp7."', ".((string)$_smarty_tpl->tpl_vars['max_displayed_qty']->value)."); return false;",'but_text'=>(($tmp = @$_smarty_tpl->tpl_vars['but_text']->value)===null||$tmp==='' ? $_smarty_tpl->__("clear") : $tmp),'but_role'=>"action",'but_icon'=>"icon-repeat",'but_target_id'=>"content_".((string)$_smarty_tpl->tpl_vars['data_id']->value)), 0);?>
