<div class="ty-search-block">
    <form action="{""|fn_url}" name="search_form" method="get">
        ...
        {strip}
            ...
            {/if}
            <input type="text" name="q" value="What can we help you find?" id="search_input{$smarty.capture.search_input_id}" title="{$search_title}" class="ty-search-block__input cm-hint" />
            {if $settings.General.search_objects}
